...
(0, _react3.storiesOf)('Sneaker button', module).add('default', function () {
  return _react2.default.createElement(_sneakerButton.SneakerButton, { title: 'sneaker button', onClick: (0, _addonActions.action)('slick') });
});